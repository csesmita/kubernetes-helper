...
sudo mv /etc/kubernetes/manifest/kube-scheduler.yaml /tmp && sudo cp kube-scheduler.yaml.multiprofiles /etc/kubernetes/manifest/kube-scheduler.yaml
sudo mv /etc/kubernetes/manifest/kube-apiserver.yaml /tmp && sudo cp kube-apiserver.yaml /etc/kubernetes/manifest/
